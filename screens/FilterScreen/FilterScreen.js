...
const FilterScreen = () => {
  ...
  return (
    <SafeAreaView style = {styles.root}>
      ...
      <Icon type="material" name="whatshot" color="black" size={28} />
      <Text style = {styles.PoppinsMed} className = "self-center text-base ml-3 ">Featured</Text>
      </View>
      {activeSection === 'featured' ? <Icon type="entypo" name="check" color="darkgreen" size={22} /> : null }
      </View>
      </TouchableOpacity>
      ...
      <View className = "flex flex-row items-center justify-between mb-3">
      <View className = "flex flex-row items-center">
      <Icon type="material" name="star" color="black" size={28} />
      <Text style={styles.PoppinsMed} className="self-center text-base ml-3">Rating</Text>
    </View>
    {activeSection === 'rating' ? <Icon type="entypo" name="check" color="darkgreen" size={22} /> : null }
  </View>
</TouchableOpacity>
...
<View className = "flex flex-row items-center justify-between mb-3">
      <View className = "flex flex-row items-center">
      <Icon type="material" name="location-on" color="black" size={28} />
      <Text style={styles.PoppinsMed} className="self-center text-base ml-3">Distance</Text>
    </View>
    {activeSection === 'distance' ? <Icon type="entypo" name="check" color="darkgreen" size={22} /> : null }
  </View>
</TouchableOpacity>
...
<View className = "flex flex-row items-center justify-between mb-3">
      <View className = "flex flex-row items-center">
      <Icon type="material" name="attach-money" color="black" size={28} />
      <Text style={styles.PoppinsMed} className="self-center text-base ml-3">Price</Text>
    </View>
    {activeSection === 'price' ? <Icon type="entypo" name="check" color="darkgreen" size={22} /> : null }
  </View>
</TouchableOpacity>

      </View>

      <Text className = "ml-3" style={styles.setDistanceTitle}>Service Type</Text>
      ...
      <Icon
        ...
        size={28}
      />
      <Text style={[styles.PoppinsMed, { color: shopSelected ? 'green' : 'black' }]}  className="self-center text-base ml-1">Shop</Text>
      </View>
      </TouchableOpacity>
      ...
      size={28}
    />
      <Text style={[styles.PoppinsMed, { color: mobileSelected ? 'green' : 'black' }]}  className="self-center text-base ml-1">Mobile</Text>
      </View>
      </TouchableOpacity>
      ...
      <Icon
        ...
        size={28}
      />
      <Text style={[styles.PoppinsMed, { color: homeSelected ? 'green' : 'black' }]}  className="self-center text-base ml-1">Home</Text>
      </View>
      </TouchableOpacity>
      </View>
      </View>
      ...
      <View style={styles.setDistanceSection}>
        ...
        />
        <Text style = {styles.PoppinsMed} className = "text-base">{distance.toFixed(0)} miles</Text>
      </View>
      </ScrollView>
      <Button
