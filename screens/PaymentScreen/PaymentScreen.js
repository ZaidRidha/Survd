  ...
  return (
    <SafeAreaView style={styles.root}>
      <Text
        ...
        className="self-center text-xl mt-2">
        {vendorName}
      </Text>
      <View
        className="mt-2"
      ...
      <ScrollView
        ...
        <View
          ...
          style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
          <View
            style={{ flex: 1, height: 1, backgroundColor: 'lightgray', alignSelf: 'center', justifyContent: 'center' }}
          />
        </View>
        ...
        <View className="flex flex-row items-center  mt-2">
          ...
          <Text
            ...
            style={styles.poppinsReg}>
            This vendor has a 10 minute late fee of:
            <Text
              style={styles.poppinsMed}
        ...
        <View className="flex flex-row items-center  mt-2">
          ...
          <Text
            className="ml-1 text-sm text-gray-600"
            style={styles.poppinsReg}>
            This vendor has a 20 minute late fee of:
            <Text
              style={styles.poppinsMed}
              className="text-red-600">
              30%(£6.50)
        ...
        <View className="flex flex-row items-center  mt-2">
          ...
          <Text
            className="ml-1 text-sm text-gray-600 "
            style={styles.poppinsReg}>
            This vendor will cancel if you are late by:
            <Text
              style={styles.poppinsMed}
              className="text-red-600">
              30 Minutes
